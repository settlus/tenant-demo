...
const QNA = [
  ...
  {
    question:
      "What happens when the user cancels the transactions of a purchased item?",
    answer:
...
export default function QnaModal({
  ...
  return (
    <>
      <Modal
        open={open}
        style="min-h-[70vh] w-[60vw] flex bg-transparent rounded-[20px] p-0"
      >
        <div className="h-full flex flex-col relative overflow-visible">
          <div className="h-full overflow-auto bg-white rounded-[20px] p-12 gap-2 text-left flex flex-col">
            ...
            <div className="flex items-center justify-center gap-4 pt-4">
              ...
              <DemoButton filled={true} handleClick={handleClose} className="w-[150px]">
                <p>Close</p>
              </DemoButton>
            </div>
          </div>

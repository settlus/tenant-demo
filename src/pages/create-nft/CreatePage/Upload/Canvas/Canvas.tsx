...
export default function Canvas({ handleFile }: propType): React.ReactElement {
  ...
  return (
    <div className='flex flex-col gap-[10px]'>
      <div className='relative p-[3px] rounded-lg bg-[#fff]'>
        <BaseTitle name='Choose T-shirt color' />
        <div className={`grid grid-rows-2 grid-cols-10 gap-[8px] mx-4 pb-3`}>
          {COLORS.map((item) => (
            <li
              key={item}
      ...
      <div className='bg-[#fff] rounded-[0.3rem] p-[0.5rem] flex flex-col justify-center'>
        <BaseTitle name='Draw your design' />
        <div className='px-[20px]'>
          <div className='flex flex-row mb-4 gap-[10px] h-[60%]'>
            <canvas
          ...
          <BasicButton filled={false} className='w-[200px]' handleClick={handleSave}>
            Finish Drawing
          </BasicButton>
        </div>
      </div>

...
export default function Intro() {
  ...
  return (
    <div className="h-[70vh] max-h-full w-[60%] flex items-center flex-col justify-center gap-[1rem] m-auto">
      <div className="text-center text-5xl font-extrabold">Experience <span className='text-[#2CD673]'>NFT Licensing</span> in a minute!</div>
      <p className='text-2xl mb-2'>
        Settlus is the upcoming standard of creator economy.
        <br />
        Experience as an avatar costume creator and learn the value of NFT
        licensing on Settlus.
      </p>
      <Card />
    </div>
  );
